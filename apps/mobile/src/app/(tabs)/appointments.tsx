  ...
  return (
    ...
    >
      <Text
        ...
        style={{ color: off ? C.offInk : C.bookedInk }}
      >
  ...
  return (
    <View collapsable={false} style={{ flex: 1 }}>
      ...
      >
        ...
        <Text
          className="ml-[10px] mt-[22px] text-[12.5px] font-bold"
          style={{ color: C.navy }}
        >
        ...
        {loading ? (
          ...
          <Text
            className="mt-[40px] text-center text-[13px]"
            style={{ color: C.offInk }}
          >
            {error}
          </Text>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      className="my-[3px] text-[25.5px] font-bold"
                      style={{ color: C.navy }}
                    >
                      {d.day}
                    </Text>
                  ...
                  <View className="ml-[13px] mr-[10px] flex-1">
                    ...
                    <View className="mt-[8px]">
                      <Meta
                        icon="person"
                        text={a.dentist?.displayName ?? "The clinic"}
                      />
                    </View>
                    <View className="mt-[20px] flex-row items-center">
                      ...
                      <View className="ml-[14px] flex-1">
                        <Meta
                          ...
                          text={
                            a.isTeleconsult ? "Video call" : "DentaCare Clinic"
                          }
                        />
                      </View>
                    </View>
          ...
          <Card height={93}>
            ...
            <View className="ml-[13px] mr-[26px] flex-1">
              ...
              <Text
                ...
                style={{ color: C.sub, lineHeight: 17 }}
              >
