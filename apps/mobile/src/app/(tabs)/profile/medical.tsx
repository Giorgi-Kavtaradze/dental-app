...
import {
  ...
  useMe,
  type Appointment,
  type MedicalHistory as History,
} from "@/lib/api";
...
export default function MedicalHistory() {
  ...
  const rows: {
  ...
  }[] = [
    {
      ...
      subtitle: missing
        ? "Not provided yet"
        : list(history?.allergies, "No known allergies"),
    },
    {
      ...
      subtitle: missing
        ? "Not provided yet"
        : list(history?.conditions, "None reported"),
    },
    {
      icon: "cross.case",
      title: "Medications",
      subtitle: missing
        ? "Not provided yet"
        : list(history?.medications, "None reported"),
    },
    {
      icon: "bandage",
