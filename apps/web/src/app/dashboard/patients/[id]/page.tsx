    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        {visits.length === 0 ? (
          ...
          <ol className="relative space-y-8 before:absolute before:bottom-2 before:left-1.25 before:top-2 before:w-px before:bg-hairline">
            {visits.map((v) => (
              <li key={v.id} className="relative pl-7">
                <span className="absolute left-0 top-1.5 h-2.75 w-2.75 rounded-full border-2 border-white bg-aqua shadow-[0_0_0_2px_rgba(36,212,223,0.25)]" />
